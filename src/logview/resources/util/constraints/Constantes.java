...
public class Constantes {
	public static Integer NIVEL_FATAL = new Integer(5);
	public static Integer NIVEL_ERROR = new Integer(4);
	public static Integer NIVEL_WARNING = new Integer(3);
	public static Integer NIVEL_INFO = new Integer(2);
	public static Integer NIVEL_DEBUG = new Integer(1);
	
	public static String DSC_NIVEL_FATAL = "FATAL";
	public static String DSC_NIVEL_ERROR = "ERROR";
	public static String DSC_NIVEL_WARNING = "WARNING";
	public static String DSC_NIVEL_INFO = "INFO";
	public static String DSC_NIVEL_DEBUG = "DEBUG";
	...
	public static String IMAGEM_FATAL = CAMINHO_IMAGEM_NIVEL+"nivel-fatal.gif";
